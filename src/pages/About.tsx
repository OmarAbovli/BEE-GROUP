    ...
    return (
        <div className="min-h-screen relative">
            <SEO
                title={t('nav.about')}
                description={language === 'ar'
                    ? "تعرف على تاريخ ورؤية ومهمة مجموعة بي للأدوية، الرائدة في تقديم الحلول الصحية المبتكرة في مصر."
                    : "Learn about the history, vision, and mission of Bee Group Pharmaceuticals, a leader in innovative health solutions in Egypt."}
                keywords={language === 'ar'
                    ? "عن مجموعة بي, رؤية الشركة, مهمة الشركة, تاريخ أدوية مصر"
                    : "about bee group, company vision, mission statement, egypt pharma history"}
            />
            <BeeBackground />
